...
<html>
  <head>
	...
	var message=null;
	 ...
	 var bool=true;
	  function open(){
	  url="<%=path%>/mess/addxintonggNews.action";
	 ...
	 function selectbook(){
	  ...
	  function shenhe(){
        window.location.href="<%=path%>/mess/shenheNews.action?id="+id;
      }
      var selectroleid;
      /*   借书 */
      function saveBorrow(){
...
<body>
 ...
 <table  align="left" width="680" border="0" cellspacing="2" style="position:relative"cellpadding="0">
  <tr>
    <td align="center" height="50px" bgcolor="#999999">系统公告 <font color="#FF0000">深色的为修改目标</font>    <a style="float: right; width: 200 ;font-size: 20" href="<%=path%>/mess/shouyeNews.html">首页</a> </td>
  </tr>
  <tr>
      ...
      <tr valign="top">
        <td><table id="booktable" width="1250" height="450" border="0" >
          <tr  height="2px"> <!-- bgcolor="B1BCEC" -->
            ...
            <td width="89.5" align="center" valign="middle" bgcolor="#B1BCEC">内容类型</td>
            <td width="89.5" align="center" valign="middle" bgcolor="#B1BCEC">标题</td>
            <td width="89.5" align="center" valign="middle" bgcolor="#B1BCEC">摘要图片</td>
            <td width="89.5" align="center" valign="middle" bgcolor="#B1BCEC">摘要文章</td>
            <td width="129.5" align="center" valign="middle" bgcolor="#B1BCEC">发布内容</td>
            <td width="69.5" align="center" valign="middle" bgcolor="#B1BCEC">期望发送时间</td>
            <td width="69.5" align="center" valign="middle" bgcolor="#B1BCEC">创建时间</td>
            <td width="69.5" align="center" valign="middle" bgcolor="#B1BCEC">审核</td>
            
            </tr>
            <c:forEach items="${datasys}" var="b">
          <tr onclick="clicke(this.sectionRowIndex,${b. detailsId})" onmouseover="checkaaaaa(${b.detailsId })" height="10px">
          <td align="center"  valign="middle" > <input type="checkbox"  id="sele${b. detailsId}"  name="checkboxBtn" onclick="xiugai(${b.detailsId })" value="${b.detailsId }" style="width: 20;height: 20"> </td>
            <td align="center"  valign="middle" >公告</td>
            <td align="center" valign="middle" >${ b.title}</td>
             <td align="center" valign="middle" ><img width=90 height=80 src='${pageContext.request.contextPath}/upload/${b.thepicture }'/></td>
            <td align="center" valign="middle" >${ b.article}</td>
            <td align="center" valign="middle" >${ b.publishcontent}</td>
            <td align="center" valign="middle" >${ b.expectthereleasedate}</td>
             <td align="center" valign="middle" >${ b.creatertime}</td> 
             <c:if test="${ b.changedbystate==true}"> <td align="center" valign="middle" >已审核</td> </c:if>
              <c:if test="${ b.changedbystate==false}"><td align="center" valign="middle" >未审核</td></c:if>
             <%-- <td align="center" valign="middle" >${ b.changedbystate}</td> 
            --%>
           <%--  <td align="center" style="display: none" valign="middle" bgcolor="#FFFFFF">${ b.}</td>
            <td align="center" style="display: none" valign="middle" bgcolor="#FFFFFF">${ b.}</td>
            <td align="center" style="display: none" valign="middle" bgcolor="#FFFFFF">${ b.}</td>
...
<div id="tb" style="position:absolute; float: left; margin:5px 10px 0 0">
	<div>
		...
		&nbsp;<a href="javascript:shenhe(this)"><img  width="20" height="20" src="images/borrowbook/shenhe.PNG"></img></a>
	</div>
	<div>
...
<div id="dlg" class="" style="position:absolute;margin:100px 100px 110px 230px ; background-color:yellow; width: 730px;height: 450px;
  ...
  <form id="fm"  method="post" enctype="multipart/form-data">
  	<table cellspacing="8px;">
  		<tr>
  			<td>内容类型：</td>
  			<td colspan="2"><input class="" id="detailsTypeID" name="datails.detailsTypeId"  required="true" /></td>
  		  <td>标题：</td>
  			<td colspan="2"><input class="" id="title" name="datails.title"  required="true" /></td>
  		<tr>
  			<td>文章摘要：</td>
  			<td colspan="2"><input class="" id="article" name="datails.article"  required="true"/></td>
  			<td>文章来源：</td>
  			<td colspan="2"><input class="" id="source" name="datails.source"  required="true"/></td>
  		</tr>
  		<tr>
  			<td>期望发布时间时间：</td>
  			<td colspan="2"><input class="sang_Calender" id="expectthereleasedate" name="datails.expectthereleasedate" /></td>
  		</tr>
  		<tr>
  			<td>摘要图片：</td>
  			<td colspan="4"><input id="thepicture" name="file"  type="file"/></td>
  			<td style="display: none" colspan="4"><input id="ybpicture"   name="datails.thepicture" /></td>
  		</tr>
  		<tr>
  		<td>发布内容：</td>
  			<td colspan="5">
  				<textarea rows="10" cols="50" name="datails.publishcontent" id="publishcontent" ></textarea>
  			</td>
  		</tr>
  		<tr>
  		   <td colspan="6">
  		...
  		<tr style="display: none">
  			<td >
  			<input class="" id="" name=""  required="true"/>
  			</td>
  		</tr>
  	</table>
  </form>
